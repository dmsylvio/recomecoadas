...
use Crater\Http\Controllers\V1\Customer\PaintProtectionWarrantyPdfController as CustomerPaintProtectionWarrantyPdfController;
...
use Crater\Http\Controllers\V1\PDF\PaintProtectionWarrantyPdfController;
...
Route::middleware('pdf-auth')->group(function () {
    ...
    // paint protection warranty pdf
    // -------------------------------------------------
    Route::get('/paint-protection-warranties/pdf/{paintProtectionWarranty:unique_hash}', PaintProtectionWarrantyPdfController::class);
});
...
Route::prefix('/customer')->group(function () {
    ...
    Route::get('/paint-protection-warranties/{email_log:token}', [CustomerPaintProtectionWarrantyPdfController::class, 'getPaintProtectionWarranty']);
    Route::get('/paint-protection-warranties/view/{email_log:token}', [CustomerPaintProtectionWarrantyPdfController::class, 'getPdf'])->name('paintProtectionWarranty');
});

...
use Crater\Http\Controllers\V1\Admin\Notation\NotationsController;
...
use Crater\Http\Controllers\V1\Admin\Plain\PlainsController;
...
//
use Crater\Http\Controllers\V1\Customer\PaintProtectionWarranty\PaintProtectionWarrantyController as CustomerProtectionPlanWarrantyController;
...
Route::prefix('/v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'company'])->group(function () {
        Route::middleware(['bouncer'])->group(function () {
            ...
            // Notations
            //----------------------------------
            Route::post('/notations/delete', [NotationsController::class, 'delete']);

            Route::resource('notations', NotationsController::class);

            // Plain Protections
            //----------------------------------
            Route::post('/plains/delete', [PlainsController::class, 'delete']);

            Route::resource('plains', PlainsController::class);
    ...
    Route::prefix('/{company:slug}/customer')->group(function () {
        ...
        Route::middleware(['auth:customer', 'customer-portal'])->group(function () {
            ...
            //
            Route::apiResource('paint-protection-warranties', CustomerProtectionPlanWarrantyController::class);

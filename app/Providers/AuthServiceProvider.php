...
use Crater\Policies\NotationPolicy;
use Crater\Policies\OwnerPolicy;
use Crater\Policies\PaymentPolicy;
use Crater\Policies\PlainPolicy;
...
class AuthServiceProvider extends ServiceProvider
{
    ...
    protected $policies = [
        ...
        \Crater\Models\Plain::class => \Crater\Policies\PlainPolicy::class,
        \Crater\Models\Notation::class => \Crater\Policies\NotationPolicy::class,
    ...
    public function boot()
    {
        ...
        Gate::define('delete multiple plains', [PlainPolicy::class, 'deleteMultiple']);
        Gate::define('delete multiple notations', [NotationPolicy::class, 'deleteMultiple']);

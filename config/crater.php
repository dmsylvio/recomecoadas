...
return [
    ...
    * Marketplace url.
    */
    'base_url' => 'https://app.autoaestheticsusa.com',
    ...
    */
    'main_menu' => [
        ...
        [
            'title' => 'navigation.notations',
            'group' => 2,
            'link' => '/admin/notations',
            'icon' => 'ClipboardCheckIcon',
            'name' => 'Notes',
            'owner_only' => false,
        ...
        [
            'title' => 'navigation.paint-protection-warranty',
            'group' => 2,
            'link' => '/admin/paint-protection-warranties',
            'icon' => 'ShieldCheckIcon',
            'name' => 'Paint Protection Warranties',
            'owner_only' => false,
    ...
    */
    'customer_menu' => [
        ...
        [
            'title' => 'Paint Protection Warranty',
            'link' => '/customer/paint-protection-warranties',
            'icon' => '',
            'name' => '',
            'ability' => '',
            'owner_only' => false,

...
return [
    'abilities' => [
        ...
        [
            "name" => "view notation",
            "ability" => "view-notation",
            "model" => Notation::class,
            "depends_on" => [
                'view-customer'
            ]
        ],
        ...
        [
            "name" => "delete notation",
            "ability" => "delete-notation",
            "model" => Notation::class,
            "depends_on" => [
                'view-notation',
                'view-customer'
        ...
        [
            "name" => "view paint protection warranty",
            "ability" => "view-paint-protection-warranty",
            "model" => PaintProtectionWarranty::class,
            "depends_on" => [
                'view-customer'
            ]
        ],
        [
            "name" => "create protection plan warranty",
            "ability" => "create-paint-protection-warranty",
            "model" => PaintProtectionWarranty::class,
            "depends_on" => [
                'view-paint-protection-warranty',
                'view-customer'
            ]
        ],
        [
            "name" => "edit protection plan warranty",
            "ability" => "edit-paint-protection-warranty",
            "model" => PaintProtectionWarranty::class,
            "depends_on" => [
                'view-paint-protection-warranty',
                'view-customer'
        ...
        [
            "name" => "delete protection plan warranty",
            "ability" => "delete-paint-protection-warranty",
            "model" => PaintProtectionWarranty::class,
            "depends_on" => [
                'view-paint-protection-warranty',
                'view-customer'

  ...
  <BasePage>
    <BasePageHeader :title="pageTitle">
      <BaseBreadcrumb>
        ...
        <BaseBreadcrumbItem :title="$tc('plains.plain', 2)" to="/admin/plain-protections" />
...
async function loadData() {
  ...
  await plainStore.fetchPlainEmployee({})
...
async function submitItem() {
  ...
  try {
    ...
    router.push('/admin/plain-protections')
  } catch (err) {
    isSaving.value = false
    return
  }

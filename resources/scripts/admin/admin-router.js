...
// Notations
const NotationsIndex = () => import('@/scripts/admin/views/notations/Index.vue');
const NotationCreate = () => import('@/scripts/admin/views/notations/Create.vue');

// Plain Protection
const PlainsIndex = () => import('@/scripts/admin/views/plains/Index.vue')
const PlainCreate = () => import('@/scripts/admin/views/plains/Create.vue')
...
export default [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'notations',
        meta: { ability: abilities.VIEW_NOTATION },
        component: NotationsIndex
      },
      {
        path: 'notations/create',
        name: 'notations.create',
        meta: { ability: abilities.CREATE_NOTATION },
        component: NotationCreate
      },
      {
        path: 'notations/:id/edit',
        name: 'notations.edit',
        meta: { ability: abilities.EDIT_NOTATION },
        component: NotationCreate
      },
      ...
      {
        path: 'plains',
        meta: { ability: abilities.VIEW_PLAIN },
        component: PlainsIndex
      },
      {
        path: 'plains/create',
        name: 'plains.create',
        meta: { ability: abilities.CREATE_PLAIN },
        component: PlainCreate
      },
      {
        path: 'plains/:id/edit',
        name: 'plains.edit',
        meta: { ability: abilities.EDIT_PLAIN },
        component: PlainCreate,
      },
